package fleamarket.taobao.com.xservicekitexample.DemoService0.handlers;
...
public class DemoService0_MessageToNative implements MessageHandler<Boolean>{
    ...
    public static void register(){
        ServiceGateway.sharedInstance().registerHandler(new DemoService0_MessageToNative());
    }
}
