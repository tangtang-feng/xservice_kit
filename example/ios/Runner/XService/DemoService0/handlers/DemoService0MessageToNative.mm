...
#import "DemoService0MessageToNative.h"
 
 @implementation DemoService0MessageToNative 
 ...
 + (void)load{
     [[ServiceGateway sharedInstance] registerHandler:[DemoService0MessageToNative new]];
 }
 - (NSString *)returnType{
   return @"BOOL";
 }
